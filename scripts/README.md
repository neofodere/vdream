...
<img src="../images/logo_vdream_helper_scripts.png" width="809.5" height="auto">
...
4. Run the script with the basic command: `powershell -ExecutionPolicy Bypass -File .\INSERT_SIGN.PS1 -rom "C:\path\to\your\rom.bin"`
