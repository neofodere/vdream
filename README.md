...
`vdream.config:` Configuration file for user preferences such as language, UI settings and general emulator options.<br>
`vdream_core.config:` Configuration file for internal emulation parameters such as the emu speed, video mode...<br>
